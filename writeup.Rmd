...
Now, we will examine trends in particular types of vehicles:
...
```{r}
ggplot(data = bridges_jan, mapping = aes(x = `Day of Week`, y = total)) +
  geom_point(color = "blue") +
  labs(title = "Total Number of Crossing Vehicles in January",
...
```{r}
ggplot(data = bridges_feb, mapping = aes(x = `Day of Week`, y = total)) +
  geom_point(color = "blue") +
  labs(title = "Total Number of Crossing Vehicles in February",
       subtitle = "By Day of Week",
       x = "Day of Week",
       y = "Number of Crossing Vehicles")
```
...
```{r}
ggplot(data = bridges_mar, mapping = aes(x = `Day of Week`, y = total)) +
  geom_point(color = "blue") +
  labs(title = "Total Number of Crossing Vehicles",
       subtitle = "By Day of Week in March",
       x = "Day of Week",
       y = "Number of Crossing Vehicles")
```

```{r}
bridges_apr <- bridges_total %>%
  filter(Month == "April") %>%
  group_by(`Day of Week`) %>%
  summarise(total = sum(`Total Vehicles`)) %>%
  arrange(desc(total))
...
```{r}
ggplot(data = bridges_apr, mapping = aes(x = `Day of Week`, y = total)) +
  geom_point(color = "blue") +
  labs(title = "Total Number of Crossing Vehicles",
       subtitle = "By Day of Week in April",
       x = "Day of Week",
       y = "Number of Crossing Vehicles")
```
